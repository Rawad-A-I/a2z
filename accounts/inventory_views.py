...
def inventory_dashboard(request):
    ...
    # Low stock alerts (queryset for iteration)
    ...
    # Debug: Ensure variables are iterable
    if not hasattr(recent_movements, '__iter__'):
        recent_movements = []
    if not hasattr(low_stock_products, '__iter__'):
        low_stock_products = []
    if not hasattr(store_locations, '__iter__'):
        store_locations = []
    
    context = {
        'total_products': total_products,
        'low_stock_products': low_stock_products,  # Queryset for iteration
        'low_stock_products_count': low_stock_products_count,  # Count for display
